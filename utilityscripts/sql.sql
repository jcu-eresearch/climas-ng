...
- subquery to sort all the vernacularName values according to our preference
	...
	from
		...
		(select   v1."taxonID",
				...
				/* votes is a count of the countries that use this particular common name */
		     	...
		     	/* priority is the "best" priority number of the countries that use this name */
